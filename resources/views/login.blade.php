...
@section('title')
    <title>Login The Arcade</title>
@endsection

@section('container')
<div class = "flex h-[calc(100vh-144px)]">

<div class="w-full my-auto max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" action="{{route('authenticate')}}", method = "POST">
        <h5 class="text-xl font-bold text-gray-900 dark:text-white">Sign in to The Arcade</h5>
        @csrf
        <div>
