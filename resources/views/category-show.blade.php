...
@section('container')
    ...
    @foreach ($category->games as $game)
        <a href="{{route('game.show', ['game' => $game->id])}}" class= "mt-10 w-full flex flex-col md:items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 h-auto md:h-64">
