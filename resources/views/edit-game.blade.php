...
@section('container')
    ...
    @method('PATCH')
        ...
        <div class = "mb-5">
            ...
            <textarea id="description" name = "description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write Game Description...">{{$game->description ?? ""}}</textarea>
        </div>
        @error('description')
            <div class = "mb-4 text-sm text-red-800 rounded-lg dark:text-red-400">{{$message}}</div>
        @enderror
        <div class = "mb-5">
            ...
            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="user_avatar_help" id="image" name = "image" type="file" value = "{{$game->image}}">
        </div>
        @error('image')
            <div class = "mb-4 text-sm text-red-800 rounded-lg dark:text-red-400">{{$message}}</div>
        @enderror
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Game</button>
    </form>
@endsection
